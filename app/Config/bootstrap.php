...
CakePlugin::load('Patent', array('routes'=>true,'bootstrap'=>true));
CakePlugin::load('Weixin', array('routes'=>false,'bootstrap'=>true));

require_once ROOT . DS . 'lib' . DS . 'ClassLoder.php';
